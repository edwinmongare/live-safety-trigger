...
export function PmdView() {
  const [data, setData] = useState<Data[]>([]);

  useEffect(() => {
    const fetchData = () => {
      fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/PMDQuestions/?limit=10000`)
